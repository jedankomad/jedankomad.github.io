...
# Postavke
RSS_FEED_URL = "https://myanimelist.net/rss.php?type=rm&u=JedanKomad"  # Promeni sa tvojim RSS URL-om
POSTS_DIR = "_manga"
SEEN_FILE = "scripts/seen_manga_reviews.txt"
